...
public enum ResponseMsg {
    ...
    CREATE_AND_START_SIGN_FLOW_SUCCESS("CREATE_AND_START_SIGN_FLOW_SUCCESS", "签署流程创建并启动成功"),
    CREATE_AND_START_SIGN_FLOW_ERROR("CREATE_AND_START_SIGN_FLOW_ERROR", "签署流程创建并启动失败"),
